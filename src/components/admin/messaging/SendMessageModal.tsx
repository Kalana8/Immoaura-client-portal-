...
export const SendMessageModal = ({ isOpen, onClose }: SendMessageModalProps) => {
          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <p className="text-sm text-blue-900">
                <span className="font-semibold">💡 Tip:</span> Messages are stored in the database and users will see them in their Messages inbox. Make sure your message is clear and helpful.
              </p>
            </div>
          </div>
        </CardContent>
