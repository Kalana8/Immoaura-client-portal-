...
import { OrderWizard } from "@/components/orders/wizard/OrderWizard";
...
const NewOrder = () => {
  ...
  const trans = translations[language]?.newOrder || translations.EN.newOrder;
